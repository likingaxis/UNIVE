...
topic_title: Sviluppo Iterativo e Modello a Spirale
semantic_units:
- id: process-iteration
  title: Process Iteration
  claims:
  - id: iteration-rationale
    statement: Requirements always evolve in large projects, requiring earlier stages
      to be reworked through process iteration.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '21'
  - id: iteration-applicability
    statement: Iteration can be applied to any generic process model.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '21'
  - id: iteration-approaches
    statement: Two related approaches to process iteration are incremental development
...
- id: incremental-development
  ...
  - id: incremental-delivery
    statement: The product is developed and delivered in successive increments or
      builds.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '22'
  - id: incremental-prototyping
    statement: Users can experiment with delivered increments acting as prototypes
      while others are developed.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '22'
  - id: incremental-benefits
    statement: It combines the advantages of rapid prototyping with a more manageable
      process and better structure.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '22'
  - id: incremental-effectiveness
    statement: It is effective when the customer wants continuous progress verification
      and when requirements change frequently.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '24'
  - id: incremental-versions
    statement: 'It can be realized in two alternative versions: with overall architecture,
      or without overall architecture, which is more risky.'
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
  ...
  - asset_id: c9a87450-191d-4d21-84a9-a5a4c2c95062
    source_id: slides-02-process-1
    page: '27'
- id: incremental-vs-waterfall
  title: Incremental vs Waterfall Model
  claims:
  - id: feedback-comparison
    statement: Waterfall provides feedback only after development ends, while Incremental
    ...
    - source_id: slides-02-process-1
      page: '28'
  - id: phase-execution
    statement: Waterfall phases are strictly sequential, while Incremental allows
      parallel phases.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '28'
  - id: design-coding-scope
    statement: Waterfall entails detailed design and coding for the whole product;
      Incremental does it per single build.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '28'
  - id: team-size
    statement: Waterfall typically uses a large development team; Incremental uses
  ...
  - id: requirements-management
    statement: Waterfall freezes requirements after specification; Incremental prioritizes
      them and modifies them easily.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
...
- id: spiral-model
  ...
  claims:
  - id: spiral-boehm
    statement: The full-spiral model was proposed by Boehm in 1988.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
...
- id: risk-management
  ...
  claims:
  - id: risk-definition
    statement: A risk is a probability that some adverse circumstance will occur.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '33'
  - id: risk-management-purpose
    statement: Risk management identifies risks and creates plans to minimize their
      effect on a project.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '33'
  - id: risk-categories
    statement: Risks are categorized into project risks (affecting schedule/resources),
      product risks (affecting quality/performance), and business risks (affecting
      the organisation).
    evidence_level: primary
    status: primary_supported
    provenance:
  ...
  - id: risk-management-process
    statement: 'The process involves four steps: Risk identification, Risk analysis,
...
- id: risk-identification
  ...
  claims:
  - id: risk-types
    statement: Risk types include Technology risks, People risks, Organisational risks,
      Tools risks, Requirements risks, and Estimation risks.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
  ...
  relationships:
  - type: part_of
    target_semantic_unit: risk-management
    description: Risk identification is the first step of the risk management process.
    provenance:
    - source_id: slides-02-process-1
      page: '35'
  visual_asset_refs:
...
- id: risk-analysis
  ...
  claims:
  - id: risk-probability
    statement: Risk probability is assessed as very low (<10%), low (10-25%), moderate
    ...
    - source_id: slides-02-process-1
      page: '39'
  - id: risk-effects
    statement: Risk effects can be catastrophic, serious, tolerable, or insignificant.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '39'
  - id: risk-ranking
    statement: Top-ten risks are identified by considering all catastrophic risks
      and serious risks with more than moderate probability, and then ranked.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
  ...
  - type: part_of
    target_semantic_unit: risk-management
    description: Risk analysis is the second step of the risk management process.
    provenance:
    - source_id: slides-02-process-1
      page: '35'
  visual_asset_refs:
...
- id: risk-planning
  ...
  - id: planning-strategies
    statement: 'Risk planning involves developing strategies to manage risk: avoidance
      (reduce probability), minimisation (reduce impact), and contingency plans (deal
      with the risk if it arises).'
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
  ...
  - type: part_of
    target_semantic_unit: risk-management
    description: Risk planning is the third step of the risk management process.
    provenance:
    - source_id: slides-02-process-1
      page: '35'
  visual_asset_refs:
...
- id: risk-monitoring
  ...
  - id: monitoring-activity
    statement: Identified risks are regularly assessed to track changes in probability
      and effects.
    evidence_level: primary
    status: primary_supported
    provenance:
  ...
  - id: monitoring-indicators
    statement: Assessment uses risk factors or potential indicators for different
      risk types, and risks are discussed at management progress meetings.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
  ...
  - type: part_of
    target_semantic_unit: risk-management
    description: Risk monitoring is the fourth step of the risk management process.
    provenance:
    - source_id: slides-02-process-1
      page: '35'
  visual_asset_refs:
  ...
  - asset_id: aa3f4b67-f515-49d8-8ad8-b3a3eddc880c
    source_id: slides-02-process-1
    page: '45'
- id: other-process-models
  title: Other Process Models
  claims:
  - id: object-oriented-model
    statement: The Object-Oriented model is an alternative process model.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '46'
  - id: concurrent-engineering-model
    statement: Simultaneous or concurrent engineering reduces development time and
      costs by making development phases coexist instead of being sequential.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
  ...
  - id: formal-methods-model
    statement: Models based on formal methods use mathematical software specification
      to eliminate ambiguity and facilitate verification. Cleanroom Software Engineering
      (1987) is an example.
    evidence_level: primary
    status: primary_supported
    provenance:
