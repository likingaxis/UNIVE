...
semantic_units:
- id: processo-software-definizione
  title: Il Processo Software
  claims:
  - id: ps-def-1
    statement: Il processo software è una serie di attività necessarie alla realizzazione
      del prodotto software nei tempi, con i costi e con le desiderate caratteristiche
      di qualità.
  ...
  - id: ps-contesto-1
    statement: Nel contesto del processo software si applicano metodi, tecniche e
      strumenti, si creano prodotti (intermedi e finali), si stabilisce il controllo
      gestionale del progetto, si garantisce la qualità e si governano le modifiche.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
  ...
  - asset_id: 7b3c4705-bd09-43ca-9050-3626aeac9be8
    source_id: slides-02-process-1
    page: '0'
- id: fasi-del-processo
  title: Fasi del Processo
  claims:
  - id: fp-ciclo-vita
    statement: 'Il processo software segue un ciclo di vita articolato in 3 stadi:
      sviluppo, manutenzione, dismissione.'
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '1'
  - id: fp-definizione
    statement: Lo stadio di sviluppo comprende fasi di definizione, che si occupano
      di 'cosa' il software deve fornire (definizione dei requisiti, specifiche).
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '1'
  - id: fp-produzione
    statement: Lo stadio di sviluppo comprende fasi di produzione, che definiscono
      'come' realizzare quanto ottenuto dalle fasi di definizione (progettazione,
      codifica, integrazione, rilascio).
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '1'
  - id: fp-manutenzione
    statement: Lo stadio di manutenzione supporta il software realizzato e prevede
    ...
    - source_id: slides-02-process-1
      page: '1'
  - id: fp-testing
    statement: Durante ogni fase si effettua il testing dei prodotti, mediante tecniche
      di verifica e validazione (V&V) sui prodotti intermedi e finali.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
  ...
  - asset_id: edda521b-c9af-43f5-8d36-5a0ffa3a043a
    source_id: slides-02-process-1
    page: '1'
- id: tipi-di-manutenzione
  title: Tipi di Manutenzione
  claims:
  - id: tm-correttiva
    statement: La manutenzione correttiva elimina i difetti (fault) che producono
      guasti (failure) del software.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '2'
  - id: tm-adattativa
    statement: La manutenzione adattativa adatta il software ai cambiamenti dell'ambiente
      operativo per cui è stato sviluppato.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '2'
  - id: tm-perfettiva
    statement: La manutenzione perfettiva estende il software per accomodare funzionalità
      aggiuntive.
    evidence_level: primary
    status: primary_supported
    provenance:
  ...
  - asset_id: e9dac647-efba-4a3c-a9c7-1a6aa736ea67
    ...
    page: '2'
- id: ciclo-di-vita
  title: Definizione di Ciclo di Vita
  claims:
  - id: cv-def
    statement: Secondo IEEE Std 610-12, il ciclo di vita è l'intervallo di tempo tra
      la nascita dell'esigenza di costruire un software e la sua dismissione.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '3'
  - id: cv-fasi
    statement: Include definizione dei requisiti, specifica, pianificazione, progetto
      preliminare e dettagliato, codifica, integrazione, testing, uso, manutenzione
      e dismissione, che possono sovrapporsi o essere iterative.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
  ...
  - asset_id: 9abdc679-9362-44e5-aa1e-5f0ceb2504c9
    source_id: slides-02-process-1
    page: '3'
- id: modelli-ciclo-di-vita
  title: Modelli di Ciclo di Vita
  claims:
  - id: mdcv-def
    statement: Il modello del ciclo di vita specifica le fasi e il loro ordine di
      esecuzione, dalla definizione dei requisiti alla dismissione.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '4'
  - id: mdcv-scelta
    statement: La scelta del modello dipende dalla natura dell'applicazione, maturità
      dell'organizzazione, metodi/tecnologie usate e vincoli del cliente.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '4'
  - id: mdcv-build-and-fix
    statement: L'assenza di un modello corrisponde allo sviluppo 'build & fix' (o
      'fix-it-later'), in cui il software è sviluppato e rilavorato fino a soddisfare
      il cliente.
    evidence_level: primary
    status: primary_supported
    provenance:
...
- id: software-prototyping
  ...
  claims:
  - id: sp-def
    statement: Il software prototyping è lo sviluppo rapido del software per elicitare
      o validare i requisiti.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '9'
  - id: sp-uso
    statement: L'uso principale dei prototipi di sistema è aiutare clienti e sviluppatori
      a comprendere i requisiti del software, supportando sia l'elicitazione (sperimentando
      come il sistema supporta il lavoro) che la validazione (rivelando errori ed
      omissioni).
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '10'
  - id: sp-rischio
    statement: Il prototyping è un'attività di riduzione del rischio (riduce i rischi
      legati ai requisiti).
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '10'
  - id: sp-benefici
    statement: 'I benefici del prototyping includono: esposizione di incomprensioni,
      identificazione di servizi mancanti o confusi, disponibilità precoce di un sistema
      funzionante, base per derivare specifiche e supporto all''addestramento utenti
      e testing prodotto.'
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '11'
  - id: sp-rapidita
    statement: Lo sviluppo rapido dei prototipi è essenziale e può richiedere l'esclusione
      di funzionalità o l'allentamento di vincoli non funzionali.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
  ...
  - asset_id: 42aa5431-126b-4bf1-a781-d2f5d44acbf7
    source_id: slides-02-process-1
    page: '12'
- id: prototypes-as-specifications
  title: Prototypes as Specifications
  claims:
  - id: pas-limiti
    statement: Alcune parti dei requisiti (es. funzioni safety-critical) possono essere
      impossibili da prototipare e quindi non appaiono nelle specifiche derivate dal
      prototipo.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '13'
  - id: pas-legale
    statement: Un'implementazione (prototipo) non ha valore legale come contratto.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '13'
  - id: pas-non-funzionali
...
- id: throw-away-prototyping
  ...
  claims:
  - id: tap-def
    statement: Un throw-away prototype è un prototipo prodotto per aiutare a scoprire
      problemi nei requisiti e poi scartato. Il prodotto finale è poi sviluppato usando
      un altro processo.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '14'
  - id: tap-prodotto-finale
    statement: Il throw-away prototype non deve essere considerato un prodotto finale,
      poiché alcune caratteristiche possono mancare, non c'è specifica per manutenzione
      a lungo termine ed è strutturato male.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
  ...
  - id: tap-delivery
    statement: La consegna di un throw-away prototype come prodotto finale non è raccomandata
      perché potrebbe essere impossibile adattarlo ai requisiti non funzionali, è
      non documentato, la struttura è degradata dai cambiamenti e gli standard di
      qualità normali non sono stati applicati.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
...
- id: visual-programming
  ...
  claims:
  - id: vp-def
    statement: Linguaggi di scripting come Visual Basic supportano la programmazione
      visuale, dove il prototipo è sviluppato creando l'interfaccia utente da componenti
      standard associati tra loro da una grande libreria.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
      page: '18'
  - id: vp-problemi
    statement: I problemi dello sviluppo visuale includono la difficoltà di coordinare
      lo sviluppo in team, l'assenza di un'architettura software esplicita e le complesse
      dipendenze tra parti del programma che causano problemi di manutenibilità.
    evidence_level: primary
    status: primary_supported
    provenance:
    - source_id: slides-02-process-1
